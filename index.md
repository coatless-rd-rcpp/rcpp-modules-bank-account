...
The `RcppBankAccount` *R* package provides an example of using [Rcpp
Modules](https://cran.r-project.org/web/packages/Rcpp/vignettes/rcpp-modules-bank-account.pdf)
to expose *C++* classes and their methods to *R*. The example hails from
working with a `BankAccount` class that is a staple of tutorials on
*C++* classes.
...
modules](https://cran.r-project.org/web/packages/Rcpp/vignettes/rcpp-modules-bank-account.pdf#page=4).
...
Inside of
[src/BankAccount.h](https://rd-rcpp.thecoatlessprofessor.com/rcpp-modules-bank-account/src/BankAccount.h),
...
[src/BankAccount.cpp](https://rd-rcpp.thecoatlessprofessor.com/rcpp-modules-bank-account/src/BankAccount.cpp)
file.
...
[src/BankAccount_export.cpp](https://rd-rcpp.thecoatlessprofessor.com/rcpp-modules-bank-account/src/BankAccount_export.cpp).
...
- Constructor:
  - `.default_constructor()`
    - Exposes the default class constructor that does *not* have any
      parameters.
...
In the
[R/BankAccount-exports.R](https://rd-rcpp.thecoatlessprofessor.com/rcpp-modules-bank-account/R/BankAccount-exports.R)
...
[`NAMESPACE`](https://rd-rcpp.thecoatlessprofessor.com/rcpp-modules-bank-account/NAMESPACE)
...
[R/RcppBankAccount-package.R](https://rd-rcpp.thecoatlessprofessor.com/rcpp-modules-bank-account/R/RcppBankAccount-package.R).
