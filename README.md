...
The `RcppBankAccount` _R_ package provides an example of using [Rcpp Modules][rcpp-modules]
...
in [Rcpp Modules Section 2.2: Exposing C++ classes using Rcpp modules][rcpp-modules-classes].
...
the definition into _R_ by creating [src/BankAccount_export.cpp][src-bankaccount-export].
...
In the [R/BankAccount-exports.R][r-bankaccount-exports] file, write the load 
...
The `roxygen2` markup required can be found in [R/RcppBankAccount-package.R][r-package].
...
[rcpp-modules]: https://cran.r-project.org/web/packages/Rcpp/vignettes/rcpp-modules-bank-account.pdf
...
[rcpp-modules-classes]: https://cran.r-project.org/web/packages/Rcpp/vignettes/rcpp-modules-bank-account.pdf#page=4
[src-bankaccount-h]: src/BankAccount.h
[src-bankaccount-cpp]: src/BankAccount.cpp
[src-bankaccount-export]: src/BankAccount_export.cpp
[r-bankaccount-exports]: R/BankAccount-exports.R
[r-package]: R/RcppBankAccount-package.R
[namespace]: NAMESPACE
